...
# Date: December 2021
# Purpose: Finish Preprocessing and run logistic regression and random forest classifiers on data with process features
####################################
...
# getting only proc features
x = x.loc[:, ['Time', 'Time of day', 'Day of the Week', 'Process Name', '5th Prev Process', '4th Prev Process',
          '3rd Prev Process', '2nd Prev Process', '1st Prev Process']]
...
lr_proc_n_va_acc_list, lr_proc_n_test_acc_list, lr_proc_n_va_roc_list, lr_proc_n_te_roc_list = \
    run_logistic_regression_users(target_users, "Process Features", x_tr, x_va, x_te, y_tr, y_va,
                                  y_te, True, True, True)

np.savetxt("lr_proc_roc_va.csv", np.array(lr_proc_n_va_roc_list), delimiter=',')
np.savetxt("lr_proc_roc_te.csv", np.array(lr_proc_n_te_roc_list), delimiter=',')
np.savetxt("lr_proc_acc_va.csv", np.array(lr_proc_n_va_acc_list), delimiter=',')
np.savetxt("lr_proc_acc_te.csv", np.array(lr_proc_n_test_acc_list), delimiter=',')

rf_proc_n_va_acc_list, rf_proc_n_test_acc_list, rf_proc_n_va_roc_list, rf_proc_n_te_roc_list = \
    run_random_forest_users(target_users, "Process Features", x_tr, x_va, x_te, y_tr, y_va, y_te, True, True, True)

np.savetxt("rf_proc_roc_va.csv", np.array(rf_proc_n_va_roc_list), delimiter=',')
np.savetxt("rf_proc_roc_te.csv", np.array(rf_proc_n_te_roc_list), delimiter=',')
np.savetxt("rf_proc_acc_va.csv", np.array(rf_proc_n_va_acc_list), delimiter=',')
np.savetxt("rf_proc_acc_te.csv", np.array(rf_proc_n_test_acc_list), delimiter=',')